...
namespace MLB_Roster_Alerts
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Populate dates in datesList and roster moves in movesList
            // datesList[0] is the date for the roster move in movesList[0]
            int iteration = 0;
            ...
            string emailBody = "";
            int moveQuantity = movesList.Count;
            for (int x = 0; x < moveQuantity; x++)
            {
                if (datesList[x] == yesterdayDate)
                {
                    emailBody += movesList[x] + "\n\n";
                }
            }
