...
6. Set "Start in" to the directory where you saved the files
7. Make sure "Allow less secure apps" is turned on in the settings for the sending Gmail account
